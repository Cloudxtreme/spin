<?php
	...
	$objPHPExcel = PHPExcel_IOFactory::load("ring_aero_report_partner_1a.xls");
	...
	$aSheet->setCellValue('H7', mb_convert_encoding(mb_convert_encoding($out_date_old, 'utf-8', 'windows-1251'), 'utf-8', 'utf-8'));
	...
	$aSheet->getStyle('A20:H'.($currRow-1))->applyFromArray($style_main_grid);
	$aSheet->getStyle('A'.$currRow.':H'.($currRow+1))->applyFromArray($style_bold_grid);
